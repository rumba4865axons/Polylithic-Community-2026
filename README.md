...
# 🎮 Polylithic — Community Edition

**Survive the Stone Age in this standalone Community Edition.**
...
Polylithic is a third-person survival game set in the Paleolithic era, where players gather resources, craft primitive tools, hunt prehistoric wildlife, and guide a small tribe through a harsh open world. This standalone Community Edition is a self-contained package that runs offline with no storefront required and no additional software required. It includes all content in a single install and is ready to play immediately on Windows 10/11.

Players who want a self-contained, offline Stone Age survival game that is ready to play immediately on Windows.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1839060/94978464ee490d70ee00de39312ac50eb9533e2c/ss_94978464ee490d70ee00de39312ac50eb9533e2c.1920x1080.jpg?t=1788297683" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1839060/30bb7114e8284bff50b2cb3b0a8723bc388c0740/ss_30bb7114e8284bff50b2cb3b0a8723bc388c0740.1920x1080.jpg?t=1788297683" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/1839060/2c50199e22b100c3a1b66e27e6944842453b3485/ss_2c50199e22b100c3a1b66e27e6944842453b3485.1920x1080.jpg?t=1788297683" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- ✅ **No Steam / indie.io Store account required**
...
- 🧺 **Stone Age Survival** — Manage hunger, thirst, body temperature, and stamina in a realistic prehistoric setting.
- 🪛 **Deep Crafting System** — Create tools, weapons, and clothing from flint, bone, wood, and hide.
- 🏕️ **Base Building** — Construct shelters, campfires, and storage structures to establish a settlement.
- 👥 **Tribe Management** — Recruit companions, assign tasks, and keep your tribe alive as it grows.
- 🌍 **Open-World Exploration** — Traverse forests, rivers, and caves across an interconnected prehistoric landscape.
- 🌓 **Day-Night Cycle and Weather** — Dynamic lighting, rain, and temperature shifts affect survival strategy.
- 🥊 **Primitive Hunting** — Track and hunt wildlife with spears, bows, and traps.
- 💾 **Fully Offline** — Single-player experience that runs entirely offline once installed.

- **Compression:** Lossless
- **Install Time:** ~5 minutes on SSD, ~12 on HDD
- **Recoding:** none
- **Selective Download:** Full package - all content included in the base download
...
| **Processor** | Intel Core i5-4590 / AMD FX-8350 | Intel Core i7-8700 / AMD Ryzen 5 3600 |
| **RAM** | 8 GB | 16 GB |
...
| **Additional** | DirectX 11 compatible system | Solid-state drive recommended for faster load times |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Polylithic\Saved`
